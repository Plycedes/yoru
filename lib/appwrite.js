...
export const likeVideo = async (userId, videoId, creatorId) => {
    try {
...
export const updateUserPfp = async (avatar, user) => {
    try {
        const avatarUrl = await uploadFile(avatar.pfp, "image");
        const userId = user.$id;

        const newPfp = await databases.updateDocument(databaseId, userCollectionId, userId, {
