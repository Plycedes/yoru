...
export const getAllPosts = (args, page, limit) => {
    return apiClient.get(`/videos/get-all-videos?page=${page}&limit=${limit}`);
};
...
export const follow = (data) => {
    return apiClient.post("/follows/follow", data);
};

export const unfollow = (data) => {
    return apiClient.post("/follows/unfollow", data);
};

export const followers = () => {
    return apiClient.get("/follows/followers");
};
